...
public class CommentController {
    ...
    @PostMapping(value = "/posts/{postId}/comments", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
    public String createComment(@PathVariable (value = "postId") Long postId, @Valid @RequestBody Comment comment) {
        /*postRepository.findById(postId).map(post -> {comment.setPost(post);
